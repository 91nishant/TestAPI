package com.example.nikumar.testapi.fingerprint;
...
public final class FingerPrintExample extends AppCompatActivity  implements View.OnClickListener {
    private static final String TAG = "FIngerPrintExample";
